...
namespace ServiceHelpers
{
    public class FaceServiceHelper
    {
        ...
        public static async Task AddPersonFaceAsync(string personGroupId, Guid personId, Stream imageStreamCallback, string userData, FaceRectangle targetFace)
        {
            await RunTaskWithAutoRetryOnQuotaLimitExceededError(async () => await faceClient.AddPersonFaceAsync(personGroupId, personId, imageStreamCallback, userData, targetFace));
        }
        ...
        public static async Task CreatePersonAsync(string personGroupId, string name, string userData)
        {
            await RunTaskWithAutoRetryOnQuotaLimitExceededError(() => faceClient.CreatePersonAsync(personGroupId, name, userData));
        }
